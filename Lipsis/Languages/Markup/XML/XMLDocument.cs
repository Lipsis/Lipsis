...
namespace Lipsis.Languages.Markup.XML {
    public class XMLDocument : MarkupDocument {
        ...
        public XMLDocument(string data, Encoding encoder) : base(data, "span", new List<string>(), new List<string>(), MarkupStandardElementFactory.Instance, encoder) { }
        public XMLDocument(byte[] data, Encoding encoder) : base(data, "span", new List<string>(), new List<string>(), MarkupStandardElementFactory.Instance, encoder) { }
        public unsafe XMLDocument(byte* data, int length, Encoding encoder) : base(data, length, "span", new List<string>(), new List<string>(), MarkupStandardElementFactory.Instance, encoder) { }
